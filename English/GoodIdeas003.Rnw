...
To continue with the rest of this section we need to know where to find \R{} on our local machine. On my computer this was \begin{center} \verb+C:\Program Files\R\R-+\Sexpr{version$major}.\Sexpr{version$minor} 
\end{center} 
...
\begin{center} 
\verb+"C:\Program Files\R\R-+\Sexpr{version$major}.\Sexpr{version$minor}\verb+\bin\Rterm.exe" < mycommands.R > myoutput.txt+ 
\end{center} 
...
\begin{center} 
\verb+"C:\Program Files\R\R-+\Sexpr{version$major}.\Sexpr{version$minor}\verb+\bin\R.exe" CMD BATCH --vanilla --quiet %1+ 
\end{center} 
