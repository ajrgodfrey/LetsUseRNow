...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{Home}\hlkwb{=}\hlkwd{c}\hlstd{(}\hlstr{"Jonathan"}\hlstd{,} \hlstr{"Olivia"}\hlstd{,} \hlstr{"Callum"}\hlstd{,} \hlstr{"Annabelle"}\hlstd{,} \hlstr{"Cordelia"}\hlstd{,} \hlstr{"Hershey"}\hlstd{,} \hlstr{"Quake"}\hlstd{)}
