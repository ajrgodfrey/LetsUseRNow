...
To continue with the rest of this section we need to know where to find \R{} on our local machine. On my computer this was \begin{center} \verb+C:\Program Files\R\R-+3.3.2 
\end{center} 
...
\begin{center} 
\verb+"C:\Program Files\R\R-+3.3.2\verb+\bin\Rterm.exe" < mycommands.R > myoutput.txt+ 
\end{center} 
...
\begin{center} 
\verb+"C:\Program Files\R\R-+3.3.2\verb+\bin\R.exe" CMD BATCH --vanilla --quiet %1+ 
\end{center} 
