...
% filename BasicInference001.Rnw 
...
% filename BasicInference002.Rnw 
...
% filename BasicInference004.Rnw 
...
\end{Soutput}
\end{Schunk}
% filename BasicInference005.Rnw 
...
% filename BasicInference006.Rnw 
...
\end{Soutput}
\end{Schunk}
% filename BasicInference007.Rnw 

or, with a nicer (quicker) command: 
% filename BasicInference008.Rnw 
...
\end{Soutput}
\end{Schunk}
% filename BasicInference009.Rnw 
...
% filename BasicInference010.Rnw 
...
\end{Soutput}
\end{Schunk}
% filename BasicInference011.Rnw 
...
% filename BasicInference012.Rnw 
...
% filename BasicInference016.Rnw 
...
\end{Sinput}
\end{Schunk}
% filename BasicInference017.Rnw 
...
% filename BasicInference018.Rnw 
...
\end{Soutput}
\end{Schunk}
% filename BasicInference019.Rnw 
...
% filename BasicInference020.Rnw 
...
\end{Soutput}
\end{Schunk}
% filename BasicInference021.Rnw 
...
% filename BasicInference022.Rnw 
