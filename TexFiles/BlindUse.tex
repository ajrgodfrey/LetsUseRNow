...
The default installation of \R{} places a shortcut on the desktop. Once you've installed \R{} in the default way, you will need to edit this shortcut's properties. Find it, hit \code{ALT+Enter} and make sure you are on the dialogue box that is for the target file. The full path is given here and the last element is ``rgui.exe". Change this last bit to read ``rterm.exe" and hit OK.
