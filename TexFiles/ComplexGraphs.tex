...
\begin{alltt}
\hlstd{> }\hlkwd{par}\hlstd{(}\hlkwc{mfrow}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{4}\hlstd{,}\hlnum{3}\hlstd{))}
\hlstd{> }\hlkwa{for}\hlstd{(Counter} \hlkwa{in} \hlnum{1}\hlopt{:}\hlnum{12}\hlstd{)\{}
\hlstd{   }\hlkwd{hist}\hlstd{(}\hlkwd{rnorm}\hlstd{(}\hlnum{100}\hlstd{),} \hlkwc{main}\hlstd{=}\hlkwd{paste}\hlstd{(}\hlstr{"Sample"}\hlstd{, Counter))\}}
\end{alltt}
\end{kframe}
\includegraphics[width=0.7\textwidth]{figures/ComplexGraphsHists12Z-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{Arrangement.mat} \hlkwb{=} \hlkwd{matrix}\hlstd{(}\hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{2}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{3}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{4}\hlstd{,}\hlnum{5}\hlstd{,}\hlnum{5}\hlstd{,}\hlnum{6}\hlstd{,}\hlnum{6}\hlstd{),} \hlkwc{byrow}\hlstd{=}\hlnum{TRUE}\hlstd{,} \hlkwc{nrow}\hlstd{=}\hlnum{4}\hlstd{)}
\hlstd{> }\hlstd{Arrangement.mat}
\end{alltt}
\begin{verbatim}
     [,1] [,2] [,3] [,4]
[1,]    1    1    1    2
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{attach}\hlstd{(quakes)}
\hlstd{> }\hlkwd{layout}\hlstd{(Arrangement.mat)}
\hlstd{> }\hlkwd{plot}\hlstd{(long, lat)}
\hlstd{> }\hlkwd{plot}\hlstd{(depth, mag,} \hlkwc{ylim}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{4}\hlstd{,}\hlnum{6.5}\hlstd{))}
\hlstd{> }\hlkwd{plot}\hlstd{(lat, mag,} \hlkwc{ylim}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{4}\hlstd{,}\hlnum{6.5}\hlstd{),} \hlkwc{cex}\hlstd{=}\hlnum{0.5}\hlstd{)}
\hlstd{> }\hlkwd{plot}\hlstd{(long, mag,} \hlkwc{ylim}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{4}\hlstd{,}\hlnum{6.5}\hlstd{),} \hlkwc{cex}\hlstd{=}\hlnum{0.25}\hlstd{)}
\hlstd{> }\hlkwd{boxplot}\hlstd{(mag,} \hlkwc{xlab}\hlstd{=}\hlstr{"Magnitude"}\hlstd{,} \hlkwc{horizontal}\hlstd{=}\hlnum{TRUE}\hlstd{)}
\hlstd{> }\hlkwd{boxplot}\hlstd{(}\hlkwd{log}\hlstd{(mag),} \hlkwc{xlab}\hlstd{=}\hlstr{"log(Magnitude)"}\hlstd{,} \hlkwc{horizontal}\hlstd{=}\hlnum{TRUE}\hlstd{)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.7\textwidth]{figures/ComplexGraphsLayoutDiffSizes-1} 
\begin{kframe}\begin{alltt}
\hlstd{> }\hlkwd{detach}\hlstd{(quakes)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(Sepal.Length}\hlopt{~}\hlstd{Sepal.Width,} \hlkwc{data}\hlstd{=iris,} \hlkwc{xlab}\hlstd{=}\hlstr{"Sepal width"}\hlstd{,} \hlkwc{ylab}\hlstd{=}\hlstr{"Sepal length"}\hlstd{,} \hlkwc{col}\hlstd{=Species)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.7\textwidth]{figures/ComplexGraphsIrisInColour-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(Petal.Length}\hlopt{~}\hlstd{Petal.Width,} \hlkwc{data}\hlstd{=iris,} \hlkwc{xlab}\hlstd{=}\hlstr{"Petal width"}\hlstd{,} \hlkwc{ylab}\hlstd{=}\hlstr{"Petal length"}\hlstd{,} \hlkwc{pch}\hlstd{=}\hlkwd{as.numeric}\hlstd{(Species))}
\end{alltt}
\end{kframe}
\includegraphics[width=0.7\textwidth]{figures/ComplexGraphsIrisInSymbols-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(ldeaths,} \hlkwc{ylim}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{4000}\hlstd{),} \hlkwc{xlab}\hlstd{=}\hlstr{"Year"}\hlstd{,} \hlkwc{ylab}\hlstd{=}\hlstr{"Number of deaths"}\hlstd{)}
\hlstd{> }\hlkwd{lines}\hlstd{(fdeaths,} \hlkwc{col}\hlstd{=}\hlstr{"red"}\hlstd{)}
\hlstd{> }\hlkwd{lines}\hlstd{(mdeaths,} \hlkwc{col}\hlstd{=}\hlstr{"blue"}\hlstd{)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.7\textwidth]{figures/ComplexGraphsDeathsTSPlot-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(lat}\hlopt{~}\hlstd{long,} \hlkwc{data}\hlstd{=quakes,} \hlkwc{xlim}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{160}\hlstd{,}\hlnum{190}\hlstd{),} \hlkwc{ylim}\hlstd{=}\hlkwd{c}\hlstd{(}\hlopt{-}\hlnum{40}\hlstd{,}\hlopt{-}\hlnum{10}\hlstd{))}
\hlstd{> }\hlkwd{abline}\hlstd{(}\hlkwc{h}\hlstd{=}\hlopt{-}\hlnum{30}\hlstd{)}
\hlstd{> }\hlkwd{abline}\hlstd{(}\hlkwc{h}\hlstd{=}\hlopt{-}\hlnum{20}\hlstd{,} \hlkwc{lty}\hlstd{=}\hlnum{1}\hlstd{)}
\hlstd{> }\hlkwd{abline}\hlstd{(}\hlkwc{v}\hlstd{=}\hlnum{180}\hlstd{,} \hlkwc{lty}\hlstd{=}\hlnum{2}\hlstd{)}
\hlstd{> }\hlkwd{abline}\hlstd{(}\hlkwc{v}\hlstd{=}\hlnum{170}\hlstd{,} \hlkwc{lty}\hlstd{=}\hlnum{3}\hlstd{)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.7\textwidth]{figures/ComplexGraphsQuakesPlaces-1} 
...
\hlstd{> }\hlkwd{curve}\hlstd{(}\hlkwd{dnorm}\hlstd{(x),} \hlopt{-}\hlnum{3}\hlstd{,}\hlnum{3}\hlstd{,} \hlkwc{add}\hlstd{=}\hlnum{TRUE}\hlstd{)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.7\textwidth]{figures/ComplexGraphsHistWithNormalCurve-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{Ozone.poly2} \hlkwb{=} \hlkwd{lm}\hlstd{(Ozone}\hlopt{~}\hlkwd{poly}\hlstd{(Wind,}\hlnum{2}\hlstd{,} \hlkwc{raw}\hlstd{=}\hlnum{TRUE}\hlstd{),} \hlkwc{data}\hlstd{=airquality)}
\hlstd{> }\hlstd{Coeffs}\hlkwb{=}\hlkwd{coef}\hlstd{(Ozone.poly2)}
\hlstd{> }\hlkwd{plot}\hlstd{(Ozone}\hlopt{~}\hlstd{Wind,} \hlkwc{data}\hlstd{=airquality)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.7\textwidth]{figures/ComplexGraphsAddPolyCurve-1} 
\begin{kframe}\begin{alltt}
\hlstd{> }\hlkwd{curve}\hlstd{(Coeffs[}\hlnum{1}\hlstd{]}\hlopt{+}\hlstd{Coeffs[}\hlnum{2}\hlstd{]}\hlopt{*}\hlstd{x}\hlopt{+}\hlstd{Coeffs[}\hlnum{2}\hlstd{]}\hlopt{*}\hlstd{x}\hlopt{^}\hlnum{2}\hlstd{,} \hlkwd{min}\hlstd{(Wind),} \hlkwd{max}\hlstd{(Wind),} \hlkwc{add}\hlstd{=}\hlnum{TRUE}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{Error in curve(Coeffs[1] + Coeffs[2] * x + Coeffs[2] * x\textasciicircum{}2, min(Wind), : object 'Wind' not found}}\end{kframe}
\end{knitrout}
...
\hlstd{> }\hlkwd{lines}\hlstd{(fdeaths,} \hlkwc{col}\hlstd{=}\hlstr{"red"}\hlstd{)}
\hlstd{> }\hlkwd{lines}\hlstd{(mdeaths,} \hlkwc{col}\hlstd{=}\hlstr{"blue"}\hlstd{)}
\hlstd{> }\hlkwd{legend}\hlstd{(}\hlstr{"topright"}\hlstd{,} \hlkwc{legend}\hlstd{=}\hlkwd{c}\hlstd{(}\hlstr{"Total"}\hlstd{,} \hlstr{"Men"}\hlstd{,} \hlstr{"Women"}\hlstd{),} \hlkwc{col}\hlstd{=}\hlkwd{c}\hlstd{(}\hlstr{"black"}\hlstd{,} \hlstr{"blue"}\hlstd{,} \hlstr{"red"}\hlstd{),} \hlkwc{lty}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{))}
\end{alltt}
\end{kframe}
\includegraphics[width=0.7\textwidth]{figures/ComplexGraphsDeathsTSPlotLegend-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{Frequency}\hlkwb{=}\hlkwd{c}\hlstd{(}\hlnum{12}\hlstd{,}\hlnum{19}\hlstd{,} \hlnum{22}\hlstd{,} \hlnum{18}\hlstd{,} \hlnum{11}\hlstd{,}\hlnum{13}\hlstd{,} \hlnum{13}\hlstd{,} \hlnum{12}\hlstd{)}
\hlstd{> }\hlstd{Gender}\hlkwb{=}\hlkwd{rep}\hlstd{(}\hlkwd{c}\hlstd{(}\hlstr{"Male"}\hlstd{,} \hlstr{"Female"}\hlstd{),} \hlnum{4}\hlstd{)}
\hlstd{> }\hlstd{Age}\hlkwb{=}\hlkwd{rep}\hlstd{(}\hlkwd{c}\hlstd{(}\hlnum{17}\hlstd{,}\hlnum{18}\hlstd{,}\hlnum{19}\hlstd{,}\hlnum{20}\hlstd{),} \hlkwc{each}\hlstd{=}\hlnum{2}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{barplot}\hlstd{(}\hlkwd{tapply}\hlstd{(Frequency,} \hlkwd{list}\hlstd{(Gender, Age), sum),} \hlkwc{col}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{2}\hlstd{,}\hlnum{4}\hlstd{),} \hlkwc{legend}\hlstd{=}\hlnum{TRUE}\hlstd{,} \hlkwc{beside}\hlstd{=}\hlnum{TRUE}\hlstd{)}
\hlstd{> }\hlkwd{title}\hlstd{(}\hlstr{"Cluster bar chart of age and gender"}\hlstd{,} \hlkwc{ylab}\hlstd{=}\hlstr{"Count"}\hlstd{,} \hlkwc{xlab}\hlstd{=}\hlstr{"Age"}\hlstd{)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.7\textwidth]{figures/ComplexGraphsClusterBar-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{barplot}\hlstd{(}\hlkwd{tapply}\hlstd{(Frequency,} \hlkwd{list}\hlstd{(Gender, Age), sum),} \hlkwc{col}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{2}\hlstd{,}\hlnum{4}\hlstd{),} \hlkwc{legend}\hlstd{=}\hlnum{TRUE}\hlstd{)}
\hlstd{> }\hlkwd{title}\hlstd{(}\hlstr{"Stack bar chart of age and gender"}\hlstd{,} \hlkwc{ylab}\hlstd{=}\hlstr{"Count"}\hlstd{,} \hlkwc{xlab}\hlstd{=}\hlstr{"Age"}\hlstd{)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.7\textwidth]{figures/ComplexGraphsStackBar-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{contour}\hlstd{(volcano)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.7\textwidth]{figures/ComplexGraphsMtEdenContour-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{example}\hlstd{(volcano)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{xUnique}\hlkwb{=}\hlstd{((}\hlnum{0}\hlopt{:}\hlnum{100}\hlstd{)}\hlopt{-}\hlnum{50}\hlstd{)}\hlopt{/}\hlnum{10}
\hlstd{> }\hlstd{yUnique}\hlkwb{=}\hlstd{((}\hlnum{0}\hlopt{:}\hlnum{100}\hlstd{)}\hlopt{-}\hlnum{50}\hlstd{)}\hlopt{/}\hlnum{10}
\hlstd{> }\hlstd{x}\hlkwb{=}\hlkwd{rep}\hlstd{(xUnique,} \hlnum{101}\hlstd{)}
\hlstd{> }\hlstd{y}\hlkwb{=}\hlkwd{rep}\hlstd{(yUnique,} \hlkwc{each}\hlstd{=}\hlnum{101}\hlstd{)}
\hlstd{> }\hlstd{z}\hlkwb{=}\hlkwd{matrix}\hlstd{(}\hlnum{0.75}\hlopt{*}\hlstd{x}\hlopt{^}\hlnum{2} \hlopt{+} \hlnum{0.5}\hlopt{*}\hlstd{y}\hlopt{^}\hlnum{2}\hlopt{-}\hlnum{0.4}\hlopt{*}\hlstd{x}\hlopt{*}\hlstd{y}\hlopt{+}\hlstd{x}\hlopt{-}\hlstd{y}\hlopt{-}\hlnum{1}\hlstd{,} \hlkwc{nrow}\hlstd{=}\hlnum{101}\hlstd{)}
\hlstd{> }\hlkwd{contour}\hlstd{(xUnique, yUnique, z)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.7\textwidth]{figures/ComplexGraphsXYZContour-1} 
