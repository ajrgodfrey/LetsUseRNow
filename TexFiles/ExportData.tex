...
\begin{alltt}
\hlstd{> }\hlkwd{write.csv}\hlstd{(Chickens,} \hlkwc{file}\hlstd{=}\hlstr{"chickens.csv"}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{write.csv}\hlstd{(Chickens,} \hlkwc{file}\hlstd{=}\hlstr{"chickens.csv"}\hlstd{,} \hlkwc{row.names}\hlstd{=}\hlnum{FALSE}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
