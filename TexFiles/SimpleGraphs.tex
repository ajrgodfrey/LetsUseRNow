...
Group 5 has 31 values.
There are no outliers marked for this group 
The whiskers extend to 5.7 and 20.1 from the ends of the box, 
which are at 8.9 and 14.05 
...
Group 6 has 30 values.
An outlier is marked at: 20.7 1.7 
The whiskers extend to 4.6 and 16.1 from the ends of the box, 
which are at 8 and 11.5 
...
Group 7 has 31 values.
There are no outliers marked for this group 
The whiskers extend to 4.1 and 14.9 from the ends of the box, 
which are at 6.9 and 10.9 
...
Group 8 has 31 values.
There are no outliers marked for this group 
The whiskers extend to 2.3 and 15.5 from the ends of the box, 
which are at 6.6 and 11.2 
...
Group 9 has 30 values.
There are no outliers marked for this group 
The whiskers extend to 2.8 and 16.6 from the ends of the box, 
which are at 7.4 and 12.6 
...
\end{Sinput}
\end{Schunk}
\includegraphics[width=0.8\textwidth,alt={a line plot}]{figures/SimpleGraphsLinePlot-1} 
...
\end{Sinput}
\end{Schunk}
\includegraphics[width=0.8\textwidth,alt={a line plot}]{figures/SimpleGraphsLinePlot2-1} 
...
\end{Sinput}
\end{Schunk}
\includegraphics[width=0.8\textwidth,alt={a normal quantile-quantile  plot}]{figures/SimpleGraphsNormPlot-1} 
...
\end{Sinput}
\end{Schunk}
\includegraphics[width=0.8\textwidth,alt={a scatter plot}]{figures/SimpleGraphsScatter-1} 
