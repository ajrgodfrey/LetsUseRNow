...
\includegraphics[width=0.8\textwidth]{figures/SimpleGraphsHistAirQualityWind-1} \end{Schunk}
...
\includegraphics[width=0.8\textwidth]{figures/SimpleGraphsHistAirQualityWind2-1} \end{Schunk}
...
\includegraphics[width=0.8\textwidth]{figures/SimpleGraphsBoxplot-1} \end{Schunk}
...
\includegraphics[width=0.8\textwidth]{figures/SimpleGraphsCompBoxplot-1} \end{Schunk}
