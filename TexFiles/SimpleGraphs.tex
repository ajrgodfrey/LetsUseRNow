...
We will use the \Robject{air quality} data set that is distributed in the \Rpackage{datasets} package which is part of the default installation of \R{}. This data set is immediately accessible from your \R{} session and can be investigated using 
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{str}\hlstd{(airquality)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{hist}\hlstd{(Wind)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.8\textwidth]{figures/SimpleGraphsHistAirQualityWind-1} 

\end{knitrout}
\SVGLink{SimpleGraphsHistAirQualityWind-1} 
\end{center} 
\end{exhibit} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{hist}\hlstd{(Wind,} \hlkwc{xlab}\hlstd{=}\hlstr{"Average wind speed (mph)"}\hlstd{,} \hlkwc{main}\hlstd{=}\hlstr{""}\hlstd{)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.8\textwidth]{figures/SimpleGraphsHistAirQualityWind2-1} 

\end{knitrout}
\SVGLink{SimpleGraphsHistAirQualityWind2-1} 
\end{center} 
\end{exhibit} 
...
\includegraphics[width=0.8\textwidth]{figures/SimpleGraphsBoxplot-1} 

\end{knitrout}
\SVGLink{SimpleGraphsBoxplot-1} 
\end{center} 
\end{exhibit} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{boxplot}\hlstd{(Wind}\hlopt{~}\hlstd{Month,} \hlkwc{xlab}\hlstd{=}\hlstr{"Month"}\hlstd{,} \hlkwc{ylab}\hlstd{=}\hlstr{"Wind speed (mph)"}\hlstd{)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.8\textwidth]{figures/SimpleGraphsCompBoxplot-1} 

\end{knitrout}
\SVGLink{SimpleGraphsCompBoxplot-1} 
\end{center} 
\end{exhibit} 
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=0.8\textwidth]{figures/SimpleGraphsDotPlot-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(Temp,} \hlkwc{ylim}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{50}\hlstd{,}\hlnum{100}\hlstd{))}
\end{alltt}
\end{kframe}
\includegraphics[width=0.8\textwidth]{figures/SimpleGraphsLinePlot-1} 

\end{knitrout}
\SVGLink{SimpleGraphsLinePlot-1} 
\end{center} 
\end{exhibit} 
\begin{exhibit} 
\begin{center} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(Temp,} \hlkwc{ylim}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{50}\hlstd{,}\hlnum{100}\hlstd{),} \hlkwc{type}\hlstd{=}\hlstr{"l"}\hlstd{)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.8\textwidth]{figures/SimpleGraphsLinePlot2-1} 

\end{knitrout}
\SVGLink{SimpleGraphsLinePlot2-1} 
\end{center} 
\end{exhibit} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{qqnorm}\hlstd{(Wind)}
\hlstd{> }\hlkwd{qqline}\hlstd{(Wind)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.8\textwidth]{figures/SimpleGraphsNormPlot-1} 

\end{knitrout}
\SVGLink{SimpleGraphsNormPlot-1} 
\end{center} 
\end{exhibit} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(Wind, Temp)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(Temp}\hlopt{~}\hlstd{Wind)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\end{alltt}
\end{kframe}
\includegraphics[width=0.8\textwidth]{figures/SimpleGraphsScatter-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{pairs}\hlstd{(}\hlkwd{data.frame}\hlstd{(Ozone, Solar.R, Wind, Temp))}
\end{alltt}
\end{kframe}
\includegraphics[width=0.8\textwidth]{figures/SimpleGraphsMatrixPlot-1} 

\end{knitrout}
\SVGLink{SimpleGraphsMatrixPlot-1} 
\end{center} 
\end{exhibit} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{str}\hlstd{(state.region)}
\end{alltt}
\begin{verbatim}
 Factor w/ 4 levels "Northeast","South",..: 2 4 4 2 4 4 1 2 2 2 ...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{levels}\hlstd{(state.region)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(state.region)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.8\textwidth]{figures/SimpleGraphsStateRegionBarChart-1} 

\end{knitrout}
\SVGLink{SimpleGraphsStateRegionBarChart-1} 
\end{center} 
\end{exhibit} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{summary}\hlstd{(state.region)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{barplot}\hlstd{(}\hlkwd{summary}\hlstd{(state.region))}
\end{alltt}
\end{kframe}
\includegraphics[width=0.8\textwidth]{figures/SimpleGraphsStateRegionBarChart2-1} 

\end{knitrout}
\SVGLink{SimpleGraphsStateRegionBarChart2-1} 
\end{center} 
\end{exhibit} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{summary}\hlstd{(state.region)[}\hlkwd{c}\hlstd{(}\hlnum{4}\hlstd{,}\hlnum{2}\hlstd{,}\hlnum{3}\hlstd{,}\hlnum{1}\hlstd{)]}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{barplot}\hlstd{(}\hlkwd{summary}\hlstd{(state.region)[}\hlkwd{c}\hlstd{(}\hlnum{4}\hlstd{,}\hlnum{2}\hlstd{,}\hlnum{3}\hlstd{,}\hlnum{1}\hlstd{)])}
\end{alltt}
\end{kframe}
\includegraphics[width=0.8\textwidth]{figures/SimpleGraphsStateRegionBarChartImp-1} 

\end{knitrout}
\SVGLink{SimpleGraphsStateRegionBarChartImp-1} 
\end{center} 
\end{exhibit} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{pie}\hlstd{(}\hlkwd{summary}\hlstd{(state.region))}
\end{alltt}
\end{kframe}
\includegraphics[width=0.8\textwidth]{figures/SimpleGraphsStateRegionPieChart-1} 

\end{knitrout}
\SVGLink{SimpleGraphsStateRegionPieChart-1} 
\end{center} 
\end{exhibit} 
