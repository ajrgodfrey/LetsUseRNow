...
\begin{alltt}
\hlstd{> }\hlkwd{library}\hlstd{(BrailleR)}
\end{alltt}
...
\ \ \ \ history}}\end{kframe}
\end{knitrout}
This chapter was created using version 0.25.3 of the \Rpkg{BrailleR} package. This version of the package has a number of other packages that it depends on for functionality. When you make the \Rpkg{BrailleR} package available, you may see a few introduction messages that tell you about the other packages being loaded. You will be told about some default settings for the package that can be altered later to suit your needs. 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{savehistory}\hlstd{(}\hlstr{"WhatIDidToday.txt"}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{MyHist} \hlkwb{=} \hlkwd{hist}\hlstd{(airquality}\hlopt{$}\hlstd{Wind,} \hlkwc{xlab}\hlstd{=}\hlstr{"Average wind speed (mph)"}\hlstd{,} \hlkwc{main}\hlstd{=}\hlstr{""}\hlstd{,} \hlkwc{plot}\hlstd{=}\hlnum{FALSE}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\color{warningcolor}{Warning in hist.default(x = airquality\$Wind, xlab = "{}Average wind speed (mph)"{}, : arguments 'main', 'xlab' are not made use of}}\end{kframe}
\end{knitrout}
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{class}\hlstd{(MyHist)}
\end{alltt}
\begin{verbatim}
[1] "histogram"
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{VI}\hlstd{(}\hlkwd{hist}\hlstd{(airquality}\hlopt{$}\hlstd{Wind,} \hlkwc{xlab}\hlstd{=}\hlstr{"Average wind speed (mph)"}\hlstd{,} \hlkwc{main}\hlstd{=}\hlstr{""}\hlstd{))}
\end{alltt}
\end{kframe}
\includegraphics[width=0.7\textwidth]{figures/VIVIHist-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{VI}\hlstd{(}\hlkwd{boxplot}\hlstd{(airquality}\hlopt{$}\hlstd{Wind,} \hlkwc{xlab}\hlstd{=}\hlstr{"Average wind speed (mph)"}\hlstd{))}
\end{alltt}
\end{kframe}
\includegraphics[width=0.7\textwidth]{figures/VIVIBoxplot-1} 
\begin{kframe}\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{VI}\hlstd{(}\hlkwd{dotplot}\hlstd{(x))}
\end{alltt}
...
\hlstd{> }\hlstd{Ozone}\hlkwb{=}\hlstd{airquality}\hlopt{$}\hlstd{Ozone}
\hlstd{> }\hlkwd{UniDesc}\hlstd{(Ozone,} \hlkwc{Folder}\hlstd{=}\hlstr{"AirQuality"}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{VI}\hlstd{(airquality)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{x}\hlkwb{=}\hlstd{(}\hlnum{0}\hlopt{:}\hlnum{100}\hlstd{)}\hlopt{/}\hlnum{100}
\hlstd{> }\hlstd{y1}\hlkwb{=}\hlnum{5}\hlopt{*}\hlstd{x}\hlopt{+}\hlkwd{rnorm}\hlstd{(}\hlnum{101}\hlstd{)}
\hlstd{> }\hlstd{y2}\hlkwb{=}\hlstd{(}\hlnum{2}\hlopt{*}\hlstd{x}\hlopt{-}\hlnum{1}\hlstd{)}\hlopt{^}\hlnum{2}\hlopt{+}\hlkwd{rnorm}\hlstd{(}\hlnum{101}\hlstd{)}\hlopt{/}\hlnum{6}
\hlstd{> }\hlstd{y3}\hlkwb{=}\hlnum{11}\hlopt{*}\hlstd{x}\hlopt{+}\hlkwd{rnorm}\hlstd{(}\hlnum{101}\hlstd{)}
\hlstd{> }\hlstd{y4}\hlkwb{=}\hlstd{y3; y4[}\hlnum{100}\hlstd{]}\hlkwb{=}\hlnum{0}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{WhereXY}\hlstd{(x,y2,} \hlkwc{grid}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{5}\hlstd{,}\hlnum{5}\hlstd{))}
\end{alltt}
\begin{verbatim}
     1  2  3  4  5 Sum
5    6  0  0  0  3   9
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{WhereXY}\hlstd{(x,y3,} \hlkwc{grid}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{5}\hlstd{,}\hlnum{5}\hlstd{))}
\end{alltt}
\begin{verbatim}
     1  2  3  4  5 Sum
5    0  0  0  3 12  15
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{WhereXY}\hlstd{(x,y4,} \hlkwc{grid}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{5}\hlstd{,}\hlnum{5}\hlstd{))}
\end{alltt}
\begin{verbatim}
     1  2  3  4  5 Sum
5    0  0  0  3 11  14
