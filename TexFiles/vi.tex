...
\includegraphics[width=0.7\textwidth]{figures/VIHist-1} \begin{Soutput}
...
\includegraphics[width=0.7\textwidth]{figures/VIHistSVG-1} 
\includegraphics[width=0.7\textwidth]{figures/VIHistSVG-2} \begin{Soutput}
...
\includegraphics[width=0.7\textwidth]{figures/VIHistSVG-3} \begin{Soutput}
