...
\Blind{The above equation is a simpler version than you will see in many textbooks. You might see a subscript on the $y$, $x$, and $\epsilon$ when referring to individual observations, but when we refer to the set of response values and the set of predictor values, we are usually thinking of them as vectors; as such, the notation above really should indicate that $y$, $x$, and $\epsilon$ are vectors. A bold face is often used for vectors and matrices or sometimes vectors are underscored. This additional notation is not used in the current context.}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{Ozone.lm1} \hlkwb{=} \hlkwd{lm}\hlstd{(Ozone}\hlopt{~}\hlstd{Wind,} \hlkwc{data}\hlstd{=airquality)}
\hlstd{> }\hlstd{Ozone.lm1}
\end{alltt}
\begin{verbatim}
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{summary}\hlstd{(Ozone.lm1)}
\end{alltt}
\begin{verbatim}
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{anova}\hlstd{(Ozone.lm1)}
\end{alltt}
\begin{verbatim}
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlstd{Ozone.lm2} \hlkwb{=} \hlkwd{lm}\hlstd{(Ozone}\hlopt{~}\hlstd{Temp,} \hlkwc{data}\hlstd{=airquality)}
\hlstd{> }\hlkwd{summary}\hlstd{(Ozone.lm2)}
\end{alltt}
\begin{verbatim}
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{anova}\hlstd{(Ozone.lm2)}
\end{alltt}
\begin{verbatim}
Analysis of Variance Table
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{names}\hlstd{(Ozone.lm1)}
\end{alltt}
\begin{verbatim}
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{names}\hlstd{(}\hlkwd{summary}\hlstd{(Ozone.lm1))}
\end{alltt}
\begin{verbatim}
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{summary}\hlstd{(Ozone.lm1)}\hlopt{$}\hlstd{r.squared}
\end{alltt}
\begin{verbatim}
[1] 0.3619
\end{verbatim}
...
\hlstd{> }\hlkwd{plot}\hlstd{(Wind, Ozone)}
\hlstd{> }\hlkwd{abline}\hlstd{(Ozone.lm1)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.7\textwidth]{figures/RegressionOzoneWindWithLine-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{plot}\hlstd{(Temp, Ozone)}
\hlstd{> }\hlkwd{abline}\hlstd{(Ozone.lm2)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.7\textwidth]{figures/RegressionOzoneTempWithLine-1} 
...
\hlstd{> }\hlkwd{plot}\hlstd{(Ozone.lm1)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.7\textwidth]{figures/RegressionOzoneWindResidPlots-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{Ozone.resid1} \hlkwb{=} \hlkwd{resid}\hlstd{(Ozone.lm1)}
\hlstd{> }\hlstd{Ozone.fitted1} \hlkwb{=} \hlkwd{fitted}\hlstd{(Ozone.lm1)}
\hlstd{> }\hlstd{Ozone.lev1} \hlkwb{=} \hlkwd{hatvalues}\hlstd{(Ozone.lm1)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{mean}\hlstd{(Ozone.lev1)}
\end{alltt}
\begin{verbatim}
[1] 0.01724
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlkwd{max}\hlstd{(Ozone.lev1)}
\end{alltt}
\begin{verbatim}
[1] 0.08854
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlstd{Ozone.lev1[Ozone.lev1}\hlopt{>}\hlnum{2}\hlopt{*}\hlkwd{mean}\hlstd{(Ozone.lev1)]}
\end{alltt}
\begin{verbatim}
...
\hlstd{> }\hlkwd{summary}\hlstd{(Ozone.poly2)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{Ozone.poly3} \hlkwb{=} \hlkwd{lm}\hlstd{(Ozone}\hlopt{~}\hlkwd{poly}\hlstd{(Wind,}\hlnum{3}\hlstd{,} \hlkwc{raw}\hlstd{=}\hlnum{TRUE}\hlstd{),} \hlkwc{data}\hlstd{=airquality)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{anova}\hlstd{(Ozone.lm1, Ozone.poly2, Ozone.poly3)}
\end{alltt}
\begin{verbatim}
Analysis of Variance Table
...
\hlstd{> }\hlkwd{points}\hlstd{(airquality}\hlopt{$}\hlstd{Wind[}\hlopt{!}\hlkwd{is.na}\hlstd{(airquality}\hlopt{$}\hlstd{Ozone)],} \hlkwd{fitted}\hlstd{(Ozone.poly2),} \hlkwc{col}\hlstd{=}\hlnum{2}\hlstd{)}
\end{alltt}
\end{kframe}
\includegraphics[width=0.7\textwidth]{figures/RegressionQuadAddPoints-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{Ozone.lm3} \hlkwb{=} \hlkwd{lm}\hlstd{(Ozone}\hlopt{~}\hlstd{Wind}\hlopt{+}\hlstd{Temp,} \hlkwc{data}\hlstd{=airquality)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{Ozone.lm4} \hlkwb{=} \hlkwd{lm}\hlstd{(Ozone}\hlopt{~}\hlkwd{poly}\hlstd{(Wind,}\hlnum{2}\hlstd{)}\hlopt{+}\hlstd{Temp,} \hlkwc{data}\hlstd{=airquality)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{anova}\hlstd{(Ozone.lm2, Ozone.lm3, Ozone.lm4)}
\end{alltt}
\begin{verbatim}
Analysis of Variance Table
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{Ozone.lm5} \hlkwb{=} \hlkwd{lm}\hlstd{(Ozone}\hlopt{~}\hlkwd{poly}\hlstd{(Wind,}\hlnum{2}\hlstd{)}\hlopt{*}\hlstd{Temp,} \hlkwc{data}\hlstd{=airquality)}
\hlstd{> }\hlkwd{summary}\hlstd{(Ozone.lm5)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlkwd{anova}\hlstd{(Ozone.lm5, Ozone.lm4)}
\end{alltt}
\begin{verbatim}
Analysis of Variance Table
