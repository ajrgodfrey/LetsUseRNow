...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{MySine2} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{x}\hlstd{)\{} \hlkwd{sin}\hlstd{(x)}
\hlstd{   }\hlkwd{print}\hlstd{(x)\}}
\hlstd{> }\hlkwd{MySine2}\hlstd{(pi}\hlopt{/}\hlnum{2}\hlstd{)}
\end{alltt}
\begin{verbatim}
[1] 1.571
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{MySine3} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{x}\hlstd{)\{} \hlkwd{return}\hlstd{(}\hlkwd{sin}\hlstd{(x))}
\hlstd{   }\hlkwd{print}\hlstd{(x)\}}
\hlstd{> }\hlkwd{MySine3}\hlstd{(pi}\hlopt{/}\hlnum{2}\hlstd{)}
\end{alltt}
\begin{verbatim}
[1] 1
\end{verbatim}
