...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{Names} \hlkwb{=} \hlkwd{c}\hlstd{(}\hlstr{"Jonathan"}\hlstd{,} \hlstr{"Elizabeth"}\hlstd{,} \hlstr{"Peter"}\hlstd{,} \hlstr{"Jenna"}\hlstd{,} \hlstr{"Callum"}\hlstd{,} \hlstr{"Annabelle"}\hlstd{,} \hlstr{"Cordelia"}\hlstd{)}
\hlstd{Names}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{Human} \hlkwb{=} \hlkwd{c}\hlstd{(}\hlnum{TRUE}\hlstd{,} \hlnum{TRUE}\hlstd{,} \hlnum{TRUE}\hlstd{,} \hlnum{FALSE}\hlstd{,} \hlnum{TRUE}\hlstd{,} \hlnum{TRUE}\hlstd{,} \hlnum{TRUE}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{Year} \hlkwb{=} \hlkwd{c}\hlstd{(}\hlnum{1971}\hlstd{,} \hlnum{1945}\hlstd{,} \hlnum{1925}\hlstd{,} \hlnum{2003}\hlstd{,} \hlnum{2010}\hlstd{,} \hlnum{2012}\hlstd{,} \hlnum{2013}\hlstd{)}
\hlstd{Month} \hlkwb{=} \hlkwd{c}\hlstd{(}\hlstr{"October"}\hlstd{,} \hlstr{"October"}\hlstd{,} \hlstr{"July"}\hlstd{,} \hlstr{"October"}\hlstd{,} \hlstr{"April"}\hlstd{,} \hlstr{"June"}\hlstd{,} \hlstr{"June"}\hlstd{)}
