...
\end{Sinput}
\begin{Soutput}
Error in data.frame(Year, Month, Human, row.names = Names): arguments imply differing number of rows: 8, 7
\end{Soutput}
\begin{Sinput}
> str(MySecondDF) 
\end{Sinput}
\begin{Soutput}
Error in str(MySecondDF): object 'MySecondDF' not found
\end{Soutput}
\end{Schunk}
