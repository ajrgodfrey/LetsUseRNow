...
\begin{alltt}
\hlstd{x}\hlkwb{=}\hlnum{100}\hlopt{/}\hlnum{7}
\hlstd{x}
\end{alltt}
\begin{verbatim}
## [1] 14.29
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{x}\hlkwb{=}\hlkwd{sqrt}\hlstd{(}\hlnum{169}\hlstd{)}
\hlstd{y}\hlkwb{=}\hlkwd{log}\hlstd{(}\hlnum{500}\hlstd{)}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{y}\hlkwb{=}\hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,} \hlnum{4}\hlstd{,} \hlnum{9}\hlstd{,} \hlnum{16}\hlstd{,} \hlnum{25}\hlstd{,} \hlnum{36}\hlstd{,} \hlnum{49}\hlstd{,} \hlnum{64}\hlstd{,} \hlnum{81}\hlstd{,} \hlnum{100}\hlstd{)}
\hlstd{y}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{y}\hlkwb{=}\hlstd{(}\hlnum{1}\hlopt{:}\hlnum{10}\hlstd{)}\hlopt{^}\hlnum{2}
\hlstd{y}
\end{alltt}
\begin{verbatim}
##  [1]   1   4   9  16  25  36  49  64  81 100
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{Names} \hlkwb{=} \hlkwd{c}\hlstd{(}\hlstr{"Jonathan"}\hlstd{,} \hlstr{"Elizabeth"}\hlstd{,} \hlstr{"Peter"}\hlstd{,} \hlstr{"Jenna"}\hlstd{,} \hlstr{"Olivia"}\hlstd{,} \hlstr{"Callum"}\hlstd{,} \hlstr{"Annabelle"}\hlstd{,} \hlstr{"Cordelia"}\hlstd{)}
\hlstd{Names}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{Human} \hlkwb{=} \hlkwd{c}\hlstd{(}\hlnum{TRUE}\hlstd{,} \hlnum{TRUE}\hlstd{,} \hlnum{TRUE}\hlstd{,} \hlnum{FALSE}\hlstd{,} \hlnum{TRUE}\hlstd{,} \hlnum{TRUE}\hlstd{,} \hlnum{TRUE}\hlstd{,} \hlnum{TRUE}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{Names[}\hlnum{2}\hlopt{:}\hlnum{3}\hlstd{]}
\end{alltt}
\begin{verbatim}
## [1] "Elizabeth" "Peter"
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{class}\hlstd{(Names)}
\end{alltt}
\begin{verbatim}
## [1] "character"
\end{verbatim}
\begin{alltt}
\hlkwd{str}\hlstd{(Names)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{Names[}\hlopt{-}\hlnum{1}\hlstd{]}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{Week} \hlkwb{=} \hlkwd{rep}\hlstd{(}\hlnum{1}\hlopt{:}\hlnum{4}\hlstd{,} \hlkwc{each}\hlstd{=}\hlnum{5}\hlstd{)}
\hlstd{Week}
\end{alltt}
\begin{verbatim}
...
\end{verbatim}
\begin{alltt}
\hlstd{Day} \hlkwb{=} \hlkwd{rep}\hlstd{(}\hlkwd{c}\hlstd{(}\hlstr{"Mon"}\hlstd{,} \hlstr{"Tue"}\hlstd{,} \hlstr{"Wed"}\hlstd{,} \hlstr{"Thu"}\hlstd{,} \hlstr{"Fri"}\hlstd{),} \hlkwc{times}\hlstd{=}\hlnum{4}\hlstd{)}
\hlstd{Day}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{rep}\hlstd{(}\hlnum{1}\hlopt{:}\hlnum{5}\hlstd{,} \hlkwc{times}\hlstd{=}\hlnum{1}\hlopt{:}\hlnum{5}\hlstd{)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{rep}\hlstd{(}\hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{2}\hlstd{,}\hlnum{4}\hlstd{),} \hlkwc{times}\hlstd{=}\hlnum{3}\hlstd{,} \hlkwc{length.out}\hlstd{=}\hlnum{8}\hlstd{)}
\end{alltt}
\begin{verbatim}
## [1] 1 2 4 1 2 4 1 2
\end{verbatim}
...
\end{verbatim}
\begin{alltt}
\hlkwd{class}\hlstd{(}\hlkwd{date}\hlstd{())}
\end{alltt}
\begin{verbatim}
## [1] "character"
\end{verbatim}
...
\end{verbatim}
\begin{alltt}
\hlkwd{class}\hlstd{(}\hlkwd{Sys.Date}\hlstd{())}
\end{alltt}
\begin{verbatim}
## [1] "Date"
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{Months} \hlkwb{=} \hlkwd{as.factor}\hlstd{(}\hlkwd{c}\hlstd{(}\hlnum{3}\hlstd{,}\hlnum{6}\hlstd{,}\hlnum{9}\hlstd{,}\hlnum{12}\hlstd{,}\hlnum{3}\hlstd{,}\hlnum{6}\hlstd{,}\hlnum{9}\hlstd{,}\hlnum{12}\hlstd{))}
\hlstd{Months}
\end{alltt}
\begin{verbatim}
## [1] 3  6  9  12 3  6  9  12
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{levels}\hlstd{(Months)} \hlkwb{=} \hlkwd{c}\hlstd{(}\hlstr{"Mar"}\hlstd{,} \hlstr{"Jun"}\hlstd{,} \hlstr{"Sep"}\hlstd{,} \hlstr{"Dec"}\hlstd{)}
\hlstd{Months}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{data.frame}\hlstd{(Names, Human)}
\end{alltt}
\begin{verbatim}
##       Names Human
## 1  Jonathan  TRUE
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{MyFirstDF} \hlkwb{=} \hlkwd{data.frame}\hlstd{(Names, Human)}
\hlkwd{str}\hlstd{(MyFirstDF)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{MyFirstDF[}\hlnum{4}\hlstd{,}\hlnum{1}\hlstd{]}
\end{alltt}
\begin{verbatim}
## [1] Jenna
...
\end{verbatim}
\begin{alltt}
\hlstd{MyFirstDF[}\hlnum{4}\hlstd{,}\hlstr{"Names"}\hlstd{]}
\end{alltt}
\begin{verbatim}
## [1] Jenna
## 8 Levels: Annabelle Callum Cordelia Elizabeth ... Peter
\end{verbatim}
\begin{alltt}
\hlstd{MyFirstDF}\hlopt{$}\hlstd{Names[}\hlnum{4}\hlstd{]}
\end{alltt}
\begin{verbatim}
## [1] Jenna
## 8 Levels: Annabelle Callum Cordelia Elizabeth ... Peter
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{Year} \hlkwb{=} \hlkwd{c}\hlstd{(}\hlnum{1971}\hlstd{,} \hlnum{1945}\hlstd{,} \hlnum{1925}\hlstd{,} \hlnum{2003}\hlstd{,} \hlnum{1982}\hlstd{,} \hlnum{2010}\hlstd{,} \hlnum{2012}\hlstd{,} \hlnum{2013}\hlstd{)}
\hlstd{Month} \hlkwb{=} \hlkwd{c}\hlstd{(}\hlstr{"October"}\hlstd{,} \hlstr{"October"}\hlstd{,} \hlstr{"July"}\hlstd{,} \hlstr{"October"}\hlstd{,} \hlstr{"December"}\hlstd{,} \hlstr{"April"}\hlstd{,} \hlstr{"June"}\hlstd{,} \hlstr{"June"}\hlstd{)}
\hlstd{MySecondDF} \hlkwb{=} \hlkwd{data.frame}\hlstd{(Year, Month, Human,} \hlkwc{row.names} \hlstd{= Names)}
\hlkwd{str}\hlstd{(MySecondDF)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{MyThirdDF} \hlkwb{=} \hlkwd{expand.grid}\hlstd{(}\hlkwc{h}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{60}\hlstd{,}\hlnum{80}\hlstd{),} \hlkwc{w}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{100}\hlstd{,} \hlnum{300}\hlstd{),} \hlkwc{sex}\hlstd{=}\hlkwd{c}\hlstd{(}\hlstr{"Male"}\hlstd{,} \hlstr{"Female"}\hlstd{))}
\hlstd{MyThirdDF}
\end{alltt}
\begin{verbatim}
##    h   w    sex
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{MyThirdDF}\hlopt{$}\hlstd{Response} \hlkwb{=} \hlkwd{rnorm}\hlstd{(}\hlnum{8}\hlstd{)}
\hlstd{MyThirdDF}
\end{alltt}
\begin{verbatim}
##    h   w    sex Response
